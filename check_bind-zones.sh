...
#WHOIS_SERVER="whois.internic.com"
# 10.08.2017 baan - Whois-Server geändert für .com/.net/.org
...
# Default named.conf
BINDCONF="/var/named/chroot/etc/named.conf"
WHOISSERVERSFILE="whois-servers.txt"
WARNDAYS=30
CRITDAYS=7
